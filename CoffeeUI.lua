...
function CoffeeUI:CreateWindow(options)
    ...
    IntroTitle.Text = "Developed by Coffee"
    ...
    SidebarFixTop.BackgroundColor3 = Colors.Sidebar
    ...
    TopbarDivider.BackgroundColor3 = Colors.Stroke
    ...
    NameLab.TextColor3 = Colors.TextPrimary
    NameLab.TextSize = 13
    ...
    GameLab.TextColor3 = Colors.TextSecondary
    GameLab.TextSize = 11
    ...
    PhoneIcon.Parent = ScreenObject
    PhoneIcon.Size = UDim2.new(0, 100, 0, 100)
    PhoneIcon.AnchorPoint = Vector2.new(0.5, 0.5)
    PhoneIcon.Position = UDim2.new(1, 0, 0, 50)
    PhoneIcon.BackgroundTransparency = 1
    PhoneIcon.Image = "rbxassetid://76824473425864"
    PhoneIcon.ImageTransparency = 0
    PhoneIcon.ScaleType = Enum.ScaleType.Fit
    PhoneIcon.Visible = false
    PhoneIcon.ZIndex = 999
    ...
    task.spawn(function()
        ...
        local glowTween = Utility:Tween(IntroTitle, {1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut}, {Size = UDim2.new(0, 480, 0, 96), Position = UDim2.new(0.5, -240, 0.5, -48)})
        task.wait(1.5)
        ...
        fadeBg.Completed:Connect(function()
            ...
            WindowOpen = true
            CoffeeUI:Notify({Title = "Loaded", Content = "coffee module loaded successfully.", Duration = 4, Theme = Theme})
        end)
    end)
    ...
    local function ToggleUI(state)
        ...
        if WindowOpen then
            ...
            PhoneIcon.Visible = true
            PhoneIcon.Size = UDim2.new(0, 100, 0, 100)
            PhoneIcon.Position = UDim2.new(0.5, 0, 0.5, 0)
            Utility:Tween(PhoneIcon, {2.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out}, {Position = UDim2.new(1, 0, 0, 50)}).Completed:Connect(function() isAnimating = false end)
        end
    end
    ...
    UserInputService.InputBegan:Connect(function(input, gp)
        ...
        if input.KeyCode == HideKey and not ParentGui:FindFirstChild("IntroOverlay") then ToggleUI(not WindowOpen) end
    end)
    ...
    function Window:CreateTab(tabName)
        ...
        TabPage.ScrollBarImageColor3 = Colors.Stroke
        ...
        local function ActivateTab()
            for _, child in pairs(TabContainer:GetChildren()) do
                if child:IsA("TextButton") then
                    Utility:Tween(child, {0.3}, {BackgroundTransparency = 1, TextColor3 = Colors.TextSecondary})
                    local ind = child:FindFirstChild("Frame")
                    if ind then Utility:Tween(ind, {0.3}, {Size = UDim2.new(0, 3, 0, 0)}) end
                end
            end
            for _, page in pairs(Pages) do
                if page.Visible then page.Visible = false page.Position = UDim2.new(0, 10, 0, 0) end
            end
        ...
        function Elements:CreateButton(options)
            ...
            BtnIcon.ImageColor3 = Colors.TextSecondary
        ...
        function Elements:CreateToggle(options)
            ...
            SliderBG.BackgroundColor3 = Colors.ToggleBg
            ...
            SStroke.Color = Colors.Stroke
            local SliderCircle = Instance.new("Frame")
            SliderCircle.Parent = SliderBG
            SliderCircle.BackgroundColor3 = Colors.ToggleOff
            ...
            local function updateToggle(anim)
                ...
                if toggled then
                    Utility:Tween(SliderBG, {time}, {BackgroundColor3 = Colors.ToggleOn})
                    Utility:Tween(SliderCircle, {time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out}, {Position = UDim2.new(1, -20, 0.5, -8), BackgroundColor3 = Colors.ButtonBg})
                    Utility:Tween(SStroke, {time}, {Color = Colors.ToggleOn})
                else
                    Utility:Tween(SliderBG, {time}, {BackgroundColor3 = Colors.ToggleBg})
                    Utility:Tween(SliderCircle, {time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out}, {Position = UDim2.new(0, 4, 0.5, -8), BackgroundColor3 = Colors.ToggleOff})
                    Utility:Tween(SStroke, {time}, {Color = Colors.Stroke})
                end
            end
            updateToggle(false)
        ...
        function Elements:CreateSlider(options)
            ...
            local function snap(v)
                ...
                if isFloat then return tonumber(string.format("%%.%df" % decimals, snapped)) end
            ...
            TitleLab.Text = name
            TitleLab.TextColor3 = Colors.TextPrimary
            ...
            ValueLab.TextColor3 = Colors.TextSecondary
            ...
            TrackFill.BackgroundColor3 = Colors.SliderFill
            ...
            HandleShadow.Color = Colors.Stroke
            ...
            DragBtn.Text = ""
            DragBtn.ZIndex = 5
            SliderFrame.MouseEnter:Connect(function() Utility:Tween(SliderFrame, {0.2}, {BackgroundColor3 = Colors.ButtonHover}) end)
            SliderFrame.MouseLeave:Connect(function() Utility:Tween(SliderFrame, {0.2}, {BackgroundColor3 = Colors.ButtonBg}) end)
        ...
        function Elements:CreateLabel(options)
            ...
            local color = options.Color or Colors.LabelColor
        ...
        function Elements:CreateSeparator(options)
            ...
            Line.BackgroundColor3 = Colors.Separator
            ...
            if text ~= "" then
                ...
                SepLab.BackgroundColor3 = Colors.Background
                ...
                SepLab.Text = "  " .. text .. "  "
                SepLab.TextColor3 = Colors.TextSecondary
                SepLab.TextSize = 11
                SepLab.ZIndex = 2
            end
        end
        function Elements:CreateKeybind(options)
            ...
            KFrame.BackgroundColor3 = Colors.ButtonBg
            ...
            KFrame.MouseEnter:Connect(function() Utility:Tween(KFrame, {0.2}, {BackgroundColor3 = Colors.ButtonHover}) end)
            KFrame.MouseLeave:Connect(function() Utility:Tween(KFrame, {0.2}, {BackgroundColor3 = Colors.ButtonBg}) end)
            ...
            UserInputService.InputBegan:Connect(function(input, gp)
                ...
                if input.UserInputType == Enum.UserInputType.Keyboard then
                    if input.KeyCode == Enum.KeyCode.Escape then currentKey = Enum.KeyCode.Unknown else currentKey = input.KeyCode end
                    listening = false
                    KeyBtn.Text = currentKey.Name
                    Utility:Tween(KBStroke, {0.2}, {Color = Colors.Stroke})
                    callback(currentKey)
                end
            end)
        end
        function Elements:CreateDropdown(options)
            ...
            ArrowLab.Text = "▼"
            ArrowLab.TextColor3 = Colors.TextSecondary
            ArrowLab.TextSize = 12
            ArrowLab.ZIndex = 11
            local ListPanel = Instance.new("Frame")
            ListPanel.Parent = DropFrame
            ListPanel.BackgroundColor3 = Colors.DropdownList
            ...
            ListScroll.ScrollBarImageColor3 = Colors.Stroke
            ...
            local function buildList()
                ...
                for _, option in ipairs(list) do
                    ...
                    Opt.BackgroundColor3 = isCurrent and Colors.Accent or Colors.DropdownList
                    ...
                    Opt.TextColor3 = isCurrent and Colors.Background or Colors.TextSecondary
                    Opt.TextSize = 13
                    Opt.TextXAlignment = Enum.TextXAlignment.Left
                    Opt.AutoButtonColor = false
                    Opt.ZIndex = 52
                    Opt.MouseEnter:Connect(function()
                        if not isCurrent then Utility:Tween(Opt, {0.12}, {BackgroundTransparency = 0, BackgroundColor3 = Colors.ButtonHover, TextColor3 = Colors.TextPrimary}) end
                    end)
                    Opt.MouseLeave:Connect(function()
                        if not isCurrent then Utility:Tween(Opt, {0.12}, {BackgroundTransparency = 1, TextColor3 = Colors.TextSecondary}) end
                    end)
            ...
            local function toggleDropdown()
                ...
                if expanded then
                    ...
                    Utility:Tween(DropFrame, {0.2}, {BackgroundColor3 = Colors.ButtonHover})
                else
                    Utility:Tween(ListPanel, {0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out}, {Size = UDim2.new(1, 0, 0, 0)})
                    Utility:Tween(ArrowLab, {0.2}, {Rotation = 0})
                    Utility:Tween(DropFrame, {0.2}, {BackgroundColor3 = Colors.DropdownBg})
                    task.wait(0.28)
            ...
            DropFrame.MouseEnter:Connect(function()
                if not expanded then Utility:Tween(DropFrame, {0.2}, {BackgroundColor3 = Colors.ButtonHover}) end
            end)
            DropFrame.MouseLeave:Connect(function()
                if not expanded then Utility:Tween(DropFrame, {0.2}, {BackgroundColor3 = Colors.DropdownBg}) end
            end)
            ...
            local DropAPI = {}
            function DropAPI:Set(option) current = option TitleLab.Text = name .. "  ›  " .. tostring(current) buildList() callback(current) end
            function DropAPI:GetSelected() return current end
            function DropAPI:Refresh(newList) list = newList buildList() end
            return DropAPI
        end
        function Elements:CreateInput(options)
            ...
            TextBoxBG.BackgroundColor3 = Colors.InputBoxBg
        ...
        function Elements:CreateColorPicker(options)
            ...
            CPFrame.BackgroundColor3 = Colors.ButtonBg
            ...
            CPLabel.Text = name
            CPLabel.TextColor3 = Colors.TextPrimary
            CPLabel.TextSize = 14
            ...
            SwatchStroke.Color = Colors.Stroke
            ...
            HeaderBtn.MouseEnter:Connect(function() Utility:Tween(CPFrame, {0.2}, {BackgroundColor3 = Colors.ButtonHover}) end)
            HeaderBtn.MouseLeave:Connect(function() Utility:Tween(CPFrame, {0.2}, {BackgroundColor3 = Colors.ButtonBg}) end)
...
function CoffeeUI:KeySystem(config)
    ...
    Card.BackgroundColor3 = Colors.KeySystemBg
    ...
    Header.BackgroundColor3 = Colors.KeySystemHeader
    Header.BorderSizePixel = 0
    Header.ZIndex = 102
    Instance.new("UICorner",Header).CornerRadius = UDim.new(0,10)
    local HFix = Instance.new("Frame",Header)
    HFix.BackgroundColor3 = Colors.KeySystemHeader
    ...
    TitleLb.Text = title
    TitleLb.TextColor3 = Colors.TextPrimary
    TitleLb.TextSize = 14
    ...
    SubLb.Text = subtitle
    SubLb.TextColor3 = Colors.TextSecondary
    SubLb.TextSize = 13
    ...
    IBox.PlaceholderColor3 = Colors.TextSecondary
    IBox.TextColor3 = Colors.TextPrimary
    ...
    StatusLb.Text = ""
    StatusLb.TextColor3 = Colors.TextSecondary
    ...
    local function MakeBtn(text, xOff, width, isPrimary)
        ...
        B.BackgroundColor3 = Colors.ButtonBg
        B.BorderSizePixel = 0
        B.AutoButtonColor = false
        B.Font = Enum.Font.Ubuntu
        B.Text = "   "..text
        B.TextColor3 = isPrimary and Colors.TextPrimary or Colors.TextSecondary
        B.TextSize = 13
    ...
    FooterLb.Text = "coffee library"
    FooterLb.TextColor3 = Colors.TextSecondary
    ...
    Utility:Tween(Card,{0.45,Enum.EasingStyle.Back,Enum.EasingDirection.Out},{Size = UDim2.fromOffset(420,195), Position = UDim2.fromScale(0.5,0.5)})
    IBox.Focused:Connect(function() Utility:Tween(IStroke,{0.2},{Color=Colors.Accent,Thickness=1.5}) end)
    IBox.FocusLost:Connect(function() Utility:Tween(IStroke,{0.2},{Color=Colors.Stroke,Thickness=1}) end)
    ...
    local function TryKey()
        if string.gsub(IBox.Text, "%s+", "") == string.gsub(validKey, "%s+", "") then
            ...
            Utility:Tween(Card,{0.35,Enum.EasingStyle.Back,Enum.EasingDirection.In},{Size=UDim2.fromOffset(360,160),Position=UDim2.fromScale(0.5,0.52)})
